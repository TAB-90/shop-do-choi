                    ...
                    <div class="form-section">
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" id="title" name="title" class="form-control @error('title') is-invalid @enderror"
                                    placeholder="Nhập tiêu đề sản phẩm" value="{{ old('title', $product->title) }}" required>
                                @error('title')
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="description" name="description" class="form-control @error('description') is-invalid @enderror" rows="6"
                                placeholder="Nhập mô tả về sản phẩm" required>{{ old('description', $product->description) }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="row mt-4">
                            <div class="form-group col-md-4">
                                ...
                                <input type="number" id="price" name="price" class="form-control @error('price') is-invalid @enderror"
                                    placeholder="0" min="0" step="1000" value="{{ old('price', $product->price) }}" required>
                                @error('price')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="form-group col-md-4">
                                ...
                                <input type="number" id="stock" name="stock" class="form-control @error('stock') is-invalid @enderror"
                                    placeholder="0" min="0" step="1" value="{{ old('stock', $product->stock) }}" required>
                                @error('stock')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="form-group col-md-4">
                                ...
                                <div class="checkbox-container">
                                    ...
                                    <label for="is_bestseller" class="form-check-label">Đánh dấu là sản phẩm bán chạy</label>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="stats-grid">
                            <div class="stat-item">
                                ...
                                <div class="stat-content">
                                    <div class="stat-number">{{ $product->carts()->count() }}</div>
                            ...
                            <div class="stat-item">
                                ...
                                <div class="stat-content">
                                    <div class="stat-number">{{ $product->favorites()->count() }}</div>
    ...
    $(document).ready(function() {
        ...
        $('#cover_image').change(function() {
            ...
            if (file) {
                ...
                @if($product->cover_image)
                    $('#image-preview').html(`<img src="{{ Storage::url($product->cover_image) }}" alt="{{ $product->title }}">`);
                @else
                    $('#image-preview').html(`
                        <div class="placeholder">
                            <i class="fas fa-image"></i>
